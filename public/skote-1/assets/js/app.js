        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      "skote/assets/images/flags/us.jpg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      "skote/assets/images/flags/spain.jpg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      "skote/assets/images/flags/germany.jpg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      "skote/assets/images/flags/italy.jpg")
                : "ru" == e &&
                  (document.getElementById("header-lang-img").src =
                      "skote/assets/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && n(a),
            s.getJSON("skote/assets/lang/" + t + ".json", function (e) {
                s("html").attr("lang", t),
    ...
    function c(e) {
        ...
        "light-mode-switch" === e
            ? (s("html").removeAttr("dir"),
              ...
              "skote/assets/css/app.min.css" != s("#app-style").attr("href") &&
                  s("#app-style").attr("href", "skote/assets/css/app.min.css"),
            ...
            ? (s("#light-mode-switch").prop("checked", !1),
              ...
              "skote/assets/css/app-rtl.min.css" != s("#app-style").attr("href") &&
                  s("#app-style").attr("href", "skote/assets/css/app-rtl.min.css"),
              s("html").attr("dir", "rtl"),
              s("html").attr("data-bs-theme", "light"),
