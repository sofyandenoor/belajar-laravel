...
function() {
  ...
  n.on({
  ...
  }).datepicker(c), $(".docs-options, .docs-toggles").on("change", function(e) {
    var t, a = e.target,
      i = $(a),
      e = i.attr("name"),
    ...
    switch (e) {
      case "container":
        ...
        break;
      case "trigger":
        s ? (s = r).prop("disabled", !1) : r.prop("disabled", !0);
        break;
      case "inline":
    ...
    c[e] = s, n.datepicker("reset").datepicker("destroy").datepicker(c)
  }), $(".docs-actions").on("click", "button", function(e) {
    var t = $(this).data(),
      a = t.arguments || [];
    e.stopPropagation(), t.method && (t.source ? n.datepicker(t.method, $(t.source).val()) : (a = n.datepicker(t.method, a[0], a[1], a[2])) && t.target && $(t.target).val(a))
  })
});
